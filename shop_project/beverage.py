#https://github.com/luyangkk/python-design-patterns/blob/master/decorator/decorator.py
...
class Beverage:
  ...
  def __init__(self):
    if self.__class__ == Beverage:
      raise NotImplementedError('Cannot create object of class Beverage')
...
class CondimentDecorator(Beverage):
  def __init__(self):
    if self.__class__ == CondimentDecorator:
      raise NotImplementedError('Cannot create object of class CondimentDecorator')
